...
public class Bank_guy {
    ...
    public void show_moves(){
        for (int i = 0; i < movements.length; i++) {
            System.out.println("importated in that moment: "+movements[i].getImportation()+"withdrawed in that movement: "+movements[i].getWithdraw()+" total money in that movement: "+movements[i].getTot_money());
        }
    }
